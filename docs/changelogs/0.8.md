...
!!! warning
    ...
    Feel free to put a comment below this page if you found any issues with the changelog.
...
Firstly, big thanks to [@zyxkad](https://github.com/zyxkad) and all the other contributors and team members who worked on this release!  
Also a huge thanks to [@Ridanisaurus](https://github.com/Ridanisaurus) rid for the new textures!  
Thanks [@cyberbit](https://github.com/cyberbit) and other community members keep giving feedback for our developing versions.
