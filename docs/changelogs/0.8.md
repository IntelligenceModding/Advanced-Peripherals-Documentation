...
You can now manage your[Dimensional Chest](https://www.curseforge.com/minecraft/mc-mods/storage-drawers). This allows you to change channels or retrieve information about the owner
    ...
    ##### [I actually didnt make a page yet](../integrations/dimchest.md)
...
We now integrate with every block that implements the create filter behavior. You can now set and read filters!
    ...
    ##### [Also no page yet, my lazy ass](../integrations/create/hihi.md)
...
We are now using snake_case for our peripheral names instead of camelCase. We know that this will result into broken scripts, but we wanted to adapt to the convention of CC's peripheral naming.
...
### Unified import/export functions
